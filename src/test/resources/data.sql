...
VALUES
  ...
  ('鈴木一郎', 'スズキイチロウ', 'イチロ', 'ichiro@example.com', '大阪', 30, '男性'),
  ('田中花子', 'タナカハナコ', 'ハナ', 'hana@example.com', '北海道', 22, '女性'),
  ('佐藤良子', 'サトウリョウコ', 'リョウ', 'ryoko@example.com', '福岡', 35, '女性'),
...
VALUES
  ...
  (3, 'マーケティングコース', '2023-09-01 10:00:00', '2024-01-01 15:00:00'),
  ...
  INSERT INTO application_status(students_course_id,status)
  VALUES(1,'仮申込'),
        (2,'本申込'),
        (3,'受講中'),
        (4,'受講終了'),
